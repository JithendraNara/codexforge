"""OpenTelemetry tracing for codexforge.
...
- ``CODEXFORGE_TRACING`` — set to ``"disabled"`` to force the no-op
...
logger = logging.getLogger("codexforge.telemetry")

_TRACING_DISABLED_ENV = "CODEXFORGE_TRACING"
_SERVICE_NAME_DEFAULT = "codexforge"
