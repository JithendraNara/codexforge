...
The test is skipped unless ``CODEXFORGE_LIVE_TEST=1`` is set and
``ANTHROPIC_AUTH_TOKEN`` is present. It drives the Claude Agent SDK
through the codexforge agent loop using a minimal ask so it stays
