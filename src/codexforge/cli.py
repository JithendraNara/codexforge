"""codexforge command-line interface."""
...
app = typer.Typer(
    help="codexforge — autonomous open-source maintainer agent platform.",
...
@app.command()
def version() -> None:
    """Print the codexforge version."""

    console.print(f"codexforge {__version__}")
...
def health() -> None:
    ...
    config = load_config()
    table = Table(title="codexforge health", show_lines=True)
