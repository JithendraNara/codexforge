...
returning. It is what makes codexforge an agent platform rather than a
thin SDK wrapper.
"""
...
from ..config import CodexForgeConfig, load_config
...
BASE_SYSTEM_PROMPT = (
    "You are codexforge's triage specialist. Use only the tool observations"
