...
from ..config import CodexForgeConfig
...
BASE_SYSTEM_PROMPT = (
    "You are codexforge, an autonomous open-source maintainer assistant."
...
def build_runtime_bundle(
    ...
    *,
    ...
    """Assemble ClaudeAgentOptions for a codexforge session."""
